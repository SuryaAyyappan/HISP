...
const Navbar = () => {
  ...
  return (
    <div className='sticky top-0 bg-black/70 md:bg-white/90 z-30 w-full flex flex-col md:flex-row md:items-center md:justify-around text-white'>
      <div
      ...
      <div className="p-4">
        <img  src='/logo1.png' width={250}  alt='Health-Insurance' />
      </div>
      <div
        className={`w-full md:w-auto z-20 transform transition-transform duration-300 ease-in-out ${
          open ? "translate-y-0" : "-translate-y-full"
        } md:translate-y-0 absolute md:relative md:flex md:flex-row px-4 py-8 md:justify-center space-y-2 md:space-y-0 md:gap-6 font-raleway text-sm md:text-xl text-black bg-background md:bg-transparent`}>
          ...
          return (
            <NavLink
              className={({ isActive }) =>
                ...
                } bg-gradient-to-tr from-blue-800 to-white bg-clip-text transition-all duration-150 ease-in`
              }
